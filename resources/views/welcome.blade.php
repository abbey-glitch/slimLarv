        ...
        <div class="row justify-content-center">
            <div class="col-lg-9 col-md-12">
                <div class="text-center">
                    <span class="d-block mb-3 text-uppercase">Prepare for new future</span>
                    <h1 class="animated fadeInUp mb-5 text-white">Helping customers be their best in the moments that matter.</h1>
                    <a href="#" target="_blank" class="btn btn-main animated fadeInUp mr-1 mb-2 mb-lg-0" >Get started<i class="btn-icon fa fa-angle-right ml-2"></i></a>
                    <a href="#" target="_blank" class="btn btn-solid-border animated fadeInUp" >Discover Sulfur</a>
                </div>
            </div>
        </div>
    </div>
...
<section class="mt--6 position-relative slider-cta">
    <div class="container">
        <div class="row align-items-center bg-primary p-4 p-sm-5 rounded">
            <div class="col-lg-8">
                <h3 class="mb-2 text-white">Crafting visually stunning memorable experiences for web.</h3>
                <p class="text-white-50">Magni perspiciatis sequi, molestias dignissimos numquam placeat eveniet nobis rerum eos, facilis minus, est illo adipisci soluta dolores quisquam, praesentium ab corrupti!</p>
            </div>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="about-img mb-5 mb-lg-0" data-aos="fade-right" data-aos-delay="200">
                    <img src="images/about/home-8.jpg" alt="" class="img-fluid">
                </div>
            </div>
            <div class="col-lg-6">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-6 text-center">
                <div class="section-title" >
                    <h2 class="mb-4">Total Solution in one</h2>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="card mb-4 p-5 text-center" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="card mb-4 p-5 text-center " data-aos="fade-up" data-aos-delay="200">
                    <i class="ti-layers text-color text-lg"></i>
                    <h4 class="mb-3 mt-4 ">Interface Design</h4>
                    <p>A digital agency isn't here to replace your internal team, we're here to partner</p>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="card mb-4 p-5 text-center " data-aos="fade-up" data-aos-delay="300">
                    ...
                    <h4 class="mb-3 mt-4 ">Business Consulting</h4>
                    <p>A digital agency isn't here to replace your internal team, we're here to partner</p>
                </div>
            </div>

            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="card mb-4 p-5 mb-lg-0 text-center " data-aos="fade-up" data-aos-delay="200">
                    <i class="ti-vector text-color text-lg"></i>
                    <h4 class="mb-3 mt-4 ">Branding</h4>
                    <p>A digital agency isn't here to replace your internal team, we're here to partner</p>
                </div>
            </div>

            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="card mb-4 p-5 mb-lg-0 text-center " data-aos="fade-up" data-aos-delay="300">
                    <i class="ti-android text-color text-lg"></i>
                    <h4 class="mb-3 mt-4 ">App development</h4>
                    <p>A digital agency isn't here to replace your internal team, we're here to partner</p>
                </div>
            </div>

            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="card mb-4 p-5 mb-lg-0 text-center " data-aos="fade-up" data-aos-delay="400">
                    <i class="ti-pencil-alt text-color text-lg"></i>
                    <h4 class="mb-3 mt-4 ">Content creation</h4>
                    <p>A digital agency isn't here to replace your internal team, we're here to partner</p>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-7 offset-lg-5">
                <div class="cta-item p-5  position-relative ml-4">
                    ...
                    <div class="cta-content-block">
                        <h2 class="mt-2 mb-4  font-secondary">Watch Latest Video</h2>
...
<!-- Section Blog Start -->
<section class="section bg-gray blog-latest">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-6 text-center">
                <div class="section-title" >
                    <h2 class="content-title mb-4">Latest News & Articles</h2>
                    <p>Don’t just take our words for it. Our clients are our biggest supporters. Would you like to know what they think about us?</p>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
                <div class="shadow-sm-2 blog-item bg-white rounded" data-aos="fade-up" data-aos-delay="200"  data-aos-duration="500" >
                     <img src="images/blog/grid-post-2-min.jpg" class="img-fluid rounded-top" alt="...">
                    <div class="p-4">
                        ...
                        <h3 class="mb-2 mt-2"><a href="blog-single.html">Brand your identity with sulfur</a></h3>
                        <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nobis, placeat.</p>
            ...
            <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
                <div class="shadow-sm-2 blog-item bg-white rounded" data-aos="fade-up" data-aos-delay="300"  data-aos-duration="500">
                     <img src="images/blog/grid-post-3-min.jpg" class="img-fluid rounded-top" alt="...">
                    <div class="p-4">
                        <div class="d-flex w-100 justify-content-between">
                        ...
                        <h3 class="mb-2 mt-2"><a href="blog-single.html">Develop your website quickly</a></h3>
                        <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nobis, placeat.</p>
                        <a href="blog-single.html" class="btn btn-main">Read More</a>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
                <div class="shadow-sm-2 blog-item bg-white rounded" data-aos="fade-up" data-aos-delay="400"  data-aos-duration="500">
                    ...
                    <div class="p-4">
                        ...
                        <h3 class="mb-2 mt-2"><a href="blog-single.html">Improve design typography </a></h3>
                        <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nobis, placeat.</p>
                        <a href="blog-single.html" class="btn btn-main">Read More</a>
                    </div>
                </div>
...
<!-- Mirrored from demo.themefisher.com/enov/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 03 Sep 2023 13:04:08 GMT -->
</html>
